...
def eval_parser():
    ...
    parser.add_argument(
        "--eval_opt", type=str, default="all", help="path to configuration file."
    )
    parser.add_argument(
        "--max_new_tokens", type=int, default=10, help="max number of generated tokens"
    )
...
def prepare_texts(texts, conv_temp):
    ...
    [
        conv.append_message(conv.roles[0], "<Img><ImageHere></Img> {}".format(text))
